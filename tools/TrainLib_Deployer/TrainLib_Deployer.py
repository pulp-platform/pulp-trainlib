...
# GENERAL PROPERTIES
project_name = 'DNN'
project_path = '../../Deployment_Folder/'           # Make sure the target project folder exists
...
layer_list = ['linear', 'linear']
# Layer properties
in_ch_list = [64, 64]       # Linear: size of input vector
out_ch_list = [64, 10]       # Linear: size of output vector
hk_list = [1, 1]                # Linear: =1
wk_list = [1, 1]                # Linear: =1
# Input activations' properties
hin_list = [1, 1]               # Linear: =1
win_list = [1, 1]               # Linear: =1
