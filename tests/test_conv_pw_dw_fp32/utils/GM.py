...
f.write('#define Tin_H_l2 (Tin_H_l1-Tker_H_l1+2*Tpad_H_l1+Tstride_H_l1)/Tstride_H_l1\n')
f.write('#define Tin_W_l2 (Tin_W_l1-Tker_W_l1+2*Tpad_W_l1+Tstride_W_l1)/Tstride_W_l1\n')
