...
static inline void forward(){
  ...
  /**  FORWARD convPW #1   **/
  #ifdef DW_FORWARD
  pulp_conv_dw_fp32_fw_cl(&layer1_in, &layer1_wgt, &layer1_out, Tpad_l1, im2col_buffer_bw);
  #endif

  #ifdef PW_FORWARD
  pulp_conv_pw_fp32_fw_cl(&layer1_out, &layer2_wgt, &layer2_out, Tpad_l2);
  #endif
}
...
static inline void train(){
  ...
  #ifdef PW_FORWARD
  pulp_conv_pw_fp32_fw_cl(&layer2_in, &layer2_wgt, &layer2_out, Tpad_l2);
  #endif
  ...
  #ifdef PW_BACKWARD_GRAD
  pulp_conv_pw_fp32_bw_param_grads_cl(&layer2_in, &layer2_wgt, &layer2_out, Tpad_l2);
  #endif

  #ifdef PW_BACKWARD_ERROR
  pulp_conv_pw_fp32_bw_input_grads_cl(&layer2_in, &layer2_wgt, &layer2_out, Tpad_l2);
  #endif
  ...
  #ifdef DW_BACKWARD_GRAD
  pulp_conv_dw_fp32_bw_param_grads_cl(&layer1_in, &layer1_wgt, &layer1_out, Tpad_l1+1, im2col_buffer_bw);
  #endif

  #ifdef DW_BACKWARD_ERROR
  pulp_conv_dw_fp32_bw_input_grads_cl(&layer1_in, &layer1_wgt, &layer1_out, Tpad_l1+1, im2col_buffer_bw);
  #endif
