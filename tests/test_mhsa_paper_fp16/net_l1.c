...
#else
PI_L2 fp16 buff_a[SEQ_LEN * HIDDEN_SIZE];
PI_L2 fp16 buff_b[SEQ_LEN * HIDDEN_SIZE];
PI_L2 fp16 buff_c[SEQ_LEN * HIDDEN_SIZE];
PI_L2 fp16 buff_d[SEQ_LEN * HIDDEN_SIZE * 4];
#endif
...
void DNN_init()
{
    ...
    mhsa_k_wgt.dim = EMBED_SIZE * HIDDEN_SIZE;
