...
static inline void forward(){
  ...
  /**  FORWARD convPW #1   **/
  #ifdef FORWARD
  pulp_conv2d_fp32_fw_cl(&layer1_in, &layer1_wgt, &layer1_out, Tpad_l1, im2col_buffer);
  #endif
}
...
static inline void train(){
  ...
  #ifdef BACKWARD_GRAD
  pulp_conv2d_fp32_bw_param_grads_cl(&layer1_in, &layer1_wgt, &layer1_out, Tpad_l1, im2col_buffer);
  #endif

  #ifdef BACKWARD_ERROR
  pulp_conv2d_fp32_bw_input_grads_cl(&layer1_in, &layer1_wgt, &layer1_out, Tpad_l1, im2col_buffer);
  #endif
