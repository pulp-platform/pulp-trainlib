...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        net.mhsa.proj_in_q.weight.data = deepcopy(in_wgt_init_tensor_q)
        net.mhsa.proj_in_k.weight.data = deepcopy(in_wgt_init_tensor_k)
        net.mhsa.proj_in_v.weight.data = deepcopy(in_wgt_init_tensor_v)
