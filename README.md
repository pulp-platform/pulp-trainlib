...
The `tools/` folder contains useful tools to complement the library, like the AutoTuner (to optimize the DNN primitives according to the DNN structure). For further info, please refer to [tools' README](tools/README.md).
...
- [x] Input gradients for DepthWise and PointWise Convolution, Fully-Connected (FP32)
...
- [ ] Input gradient computation of Conv2D layer
