...
/**
 * Transposed 2D Convolution layer configuration structure
 */
 ...
 * @param inLpad input left padding
 * @param inRpad input right padding
 * @param inUpad input upper padding
 * @param inDpad input lower padding
 * @param stride_w stride in input width
 * @param stride_h stride in input height
 * @param i2c_buffer pointer to the im2col buffer
 * @param bt_buffer pointer to the blocktranspose buffer
 ...
 */
struct Transp_Conv2D_args_fp16 {
