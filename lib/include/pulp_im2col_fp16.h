...
/**
 * @brief Performs block transposition for Conv2D IN GRAD computation (so to perform it with standard matmul kernels). Use pi_cl_team_fork(NUM_CORES, pulp_blocktransp_fp16, &args) to parallelize.
 * @param void_args pointer to struct blocktransp_args_fp16
 */
