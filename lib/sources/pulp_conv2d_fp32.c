...
void pulp_conv2d_fp32_fw_cl(struct blob * input, struct blob * coeff, struct blob * output, int pad, float * i2c_buffer)
{
...
void pulp_conv2d_fp32_bw_cl(struct blob * input, struct blob * coeff, struct blob * output, int pad, float * i2c_buffer)
{
    pulp_conv2d_fp32_bw_param_grads_cl(input, coeff, output, pad, i2c_buffer);
    pulp_conv2d_fp32_bw_input_grads_cl(input, coeff, output, pad, i2c_buffer);
}



void pulp_conv2d_fp32_bw_param_grads_cl(struct blob * input, struct blob * coeff, struct blob * output, int pad, float * i2c_buffer)
{
    struct matMul_args matMul_args;
    struct im2col_args im2col_args;
...
void pulp_conv2d_fp32_bw_input_grads_cl(struct blob * input, struct blob * coeff, struct blob * output, int pad, float * i2c_buffer)
{
  struct matMul_args matMul_args;
  struct im2col_args im2col_args;
