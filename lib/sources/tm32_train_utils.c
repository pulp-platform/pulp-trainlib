...
// =====> CONV2D
    if (layer_type == LAYER_CONV2D) 
    {
        ...
        if (step_type == STEP_FW)
        {
            ...
            // Unrolling
            else if (matmul_type == 1)      { mm_u2((void *) matMul_args);}
            else if (matmul_type == 2)      { mm_unroll_1x2((void *) matMul_args);}
            else if (matmul_type == 3)      { mm_unroll_1x4((void *) matMul_args);}
            else if (matmul_type == 4)      { mm_unroll_1x8((void *) matMul_args);}
            else if (matmul_type == 5)      { mm_unroll_2x1((void *) matMul_args);}
            else if (matmul_type == 6)      { mm_unroll_4x1((void *) matMul_args);}
            else if (matmul_type == 7)      { mm_unroll_8x1((void *) matMul_args);}
            else if (matmul_type == 8)      { mm_unroll_2x2((void *) matMul_args);}
            else if (matmul_type == 9)      { mm_unroll_2x4((void *) matMul_args);}
            else if (matmul_type == 10)     { mm_unroll_4x2((void *) matMul_args);}
            else if (matmul_type == 11)     { mm_unroll_4x4((void *) matMul_args);}
            else
            {
