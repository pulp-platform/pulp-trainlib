...
void pulp_conv_pw_fp32_fw_cl(struct blob * input, struct blob * coeff, struct blob * output, int pad) {
...
void pulp_conv_pw_fp32_bw_cl(struct blob * input, struct blob * coeff, struct blob * output, int pad) 
{
  pulp_conv_pw_fp32_bw_param_grads_cl(input, coeff, output, pad);
  pulp_conv_pw_fp32_bw_input_grads_cl(input, coeff, output, pad);
}



void pulp_conv_pw_fp32_bw_param_grads_cl(struct blob * input, struct blob * coeff, struct blob * output, int pad) 
{
  struct matMul_args matMul_args;
...
void pulp_conv_pw_fp32_bw_input_grads_cl(struct blob * input, struct blob * coeff, struct blob * output, int pad) 
{
