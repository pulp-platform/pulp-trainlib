...
void stm32_conv_dw_fp32_fw(struct blob * input, struct blob * coeff, struct blob * output, int Lpad,	int Rpad,	int Upad,	int Dpad, float * i2c_buffer, int opt_matmul_type) 
{
...
void stm32_conv_dw_fp32_bw(struct blob * input, struct blob * coeff, struct blob * output, int Lpad,	int Rpad,	int Upad,	int Dpad, float * i2c_buffer, int skip_in_grad, int opt_matmul_type_wg, int opt_matmul_type_ig)
{
  stm32_conv_dw_fp32_bw_param_grads(input, coeff, output, Lpad, Rpad, Upad, Dpad, i2c_buffer, opt_matmul_type_wg);
  if (skip_in_grad == 0)
  {
    stm32_conv_dw_fp32_bw_input_grads(input, coeff, output, Lpad, Rpad, Upad, Dpad, i2c_buffer, opt_matmul_type_ig);
  }
}



void stm32_conv_dw_fp32_bw_param_grads(struct blob * input, struct blob * coeff, struct blob * output, int Lpad,	int Rpad,	int Upad,	int Dpad, float * i2c_buffer, int opt_matmul_type)
{
  struct matMul_DW_args matMul_args;
  struct im2col_args im2col_args;
...
void stm32_conv_dw_fp32_bw_input_grads(struct blob * input, struct blob * coeff, struct blob * output, int Lpad,	int Rpad,	int Upad,	int Dpad, float * i2c_buffer, int opt_matmul_type)
{
  struct matMul_DW_args matMul_args;
  struct im2col_args im2col_args;
